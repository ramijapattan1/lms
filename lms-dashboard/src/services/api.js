...
export const api = {
  ...
  mockQuizAttempt: (id, attempt) => apiClient.post(`/quizzes/${id}/mock-attempt`, attempt),
  ...
  // Course Progress
  getCourseProgressData: (courseId) => apiClient.get(`/course-progress/${courseId}/progress`),
