...
import { FaPlus, FaClock, FaCheck, FaTrash, FaEdit, FaEye, FaEyeSlash } from 'react-icons/fa';
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex space-x-2">
                      <Link
                        ...
                        className="flex-1 text-center py-2 text-blue-500 border border-blue-500 rounded hover:bg-blue-50"
                      >
